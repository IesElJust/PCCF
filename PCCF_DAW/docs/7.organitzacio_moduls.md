...
* Per tal de facilitar l'Aprenentatge Basat en Projectes (ABP), les hores del projecte intermodular (PI) s'associaran o distribuiran entre mòduls del cicle. Aquesta assignació es realitzarà durant la tria d'horaris i podrà variar segons l'organització anual de l'equip docent.
