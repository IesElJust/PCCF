...
??? success "Materials"
    - **Materials físics**: Cables de xarxa (UTP cat6, fibra òptica), connectors RJ45, racks, canalitzacions, eines (crimpadores, testadors de xarxa, taladres, etc.).
    - **Materials didàctics**: Guies d'instal·lació, manuals de configuració, tutorials en vídeo.
    - **Recursos digitals**: Simuladors de xarxa (Virtual Box), eines de documentació tècnica (Teams, Aules).
...
<table>
    ...
    <tr>
        ...
        <td>Tacs, brides, cargols, femelles, grapes.</td>
        <td class="saber-hacer">
...
<table>
    ...
    <tr>
        ...
        <td class="saber-estar">
            Respecta els temps i processos establerts.
        </td>
    </tr>
    <tr>
...
<table>
    ...
    <tr>
        ...
        <td class="saber-hacer">
            <span class="bold">Realitza</span> correctament el tall i <span class="bold">etiqueta</span> segons la normativa.
        </td>
        <td></td>
    </tr>
    <tr>
