...
Tal i com s'indica en l'article 9.2 del **Decret 114/2025 de 29 de juliol, del Consell**, les programacions didàctiques inclouran:
...
- Les programacions didàctiques seran úniques per a cada mòdul formatiu del curs d'especialització.
- Dins de cada programació s'especificaran les metodologies aplicables al mòdul.
- Aquestes es concretaran en les respectives programacions d'aula.
