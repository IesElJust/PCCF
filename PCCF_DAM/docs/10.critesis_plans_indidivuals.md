...
5. **Realisme i viabilitat**
    * Ajustar objectius i activitats a les hores disponibles de la Formació en Empresa (FEE).
...
6. **Avaluació i seguiment**
    * Definir indicadors clars per mesurar si l'alumnat ha assolit cada resultat d'aprenentatge objectiu.
