...
La competència general d'aquest títol consisteix a desenvolupar, implantar, documentar i mantenir aplicacions informàtiques per a diversos dispositius i sistemes operatius. Això es realitza fent ús de tecnologies i entorns específics que garanteixen l'accés segur a les dades, la usabilitat i els estàndards de qualitat establerts.
