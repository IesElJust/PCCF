...
<!-- Per a SMX queda per exemple de la següent manera -->
...
- UC0220_2: Instal.lar, configurar i verificar els elements de la xarxa local segons procedimients establerts.

- UC0221_2: Instal.lar, configurar i mantindre paquets informàtics de propòsit general i aplicacions específiques.

- UC0222_2: Facilitar a l'usuario la utilizació de paquetes informàticos de propósit general i aplicacions específiques. 

**Montaje i reparació de sistemes microinformàtics IFC298_2** (Reial Decret 1201/2007, 14 septembre), que compren les següents unitats de competència: 

- UC0953_2: Montar equips microinformàtics.

- UC0219_2: Instal.lar i configurar el programari base a sistemes microinformàtics.
  
-  UC0954_2: Reparar i ampliar equipamient microinformàtic. 
  
**Operació de xarxes departamentals IFC299_2** (Reial Decret 1201/2007, 14 septembre), que comprende les següents unitats de competència: 

- UC0220_2: Instal.lar, configurar i verificar els elements de la xarxa local segons procedimients preestablets.

- UC0955_2: Monitorizar els processos de comunicacions a la xarxa local.
- UC0956_2: Real.lizar los procesos de conexión entre xarxas privades i xarxes públiques. 

**Operació de sistemes informàtics IFC300_2** (Reial Decret 1201/2007, 14 septembre), que compren les següents unitats de competència:

-  UC0219_2: Instal.lar i configurar el programari base en sistemes microinformàtics.

- UC0957_2: Mantidre i regular el subsistema físic en sistemes informàtics. UC0958_2: Ejecutar procedimientos de administración i mantenimiento en el programari base i de aplicación del client.
  
-  UC0959_2: Mantidre la seguridad de los subsistemes físics i lògic en sistemes informàtics. 
<!-- A la guia s'expressa en forma de taules.

Per completar estes taules, hem d'acudir al RD del títol original (no a la modificació), i buscar les convalidacions (Correspondencia de las unidades de competencia acreditadas de acuerdo a lo establecido en el artículo 8 de la Ley Orgànica 5/2002, de 19 de junio, con los módulos profesionales para su convalidación)
...
{qualificacions_professionals_SMX}"CFGM Sistemes Microinformatics i Xarxes(2000 h)"
