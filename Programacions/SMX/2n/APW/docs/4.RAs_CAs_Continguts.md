...
Els Resultats d'Aprenentatge (RA) i els Criteris d'Avaluació (CA) oficials del mòdul **Aplicacions Web** (codi 0228) constitueixen el referent principal de la programació.
...
En el nostre cas, els continguts s'organitzen al voltant de la instal·lació, configuració, administració i verificació de diferents famílies d'aplicacions web.
