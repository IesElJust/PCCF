...
Els Resultats d'Aprenentatge (RA) i els Criteris d'Avaluació (CA) oficials del mòdul **Sistemes Operatius en Xarxa** (codi 0224) constitueixen el referent principal de la programació.
