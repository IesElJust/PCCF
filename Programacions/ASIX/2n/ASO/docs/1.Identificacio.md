...
* **Cicle Formatiu**: Administració de Sistemes Informàtics i Xarxes (ASIX)
* **Durada**: 2000 hores

## Dades específiques del mòdul

* **Identificació** 
  * **Denominació**: Administració de Sistemes Operatius (ASO)
  * **Codi**: 0374
* **Docent(s) responsable(s)**
  * Sergio Ortiz Agudo
...
- [X] RD 1629/2009, de 30 de octubre
- [X] ORDEN 36/2012, de 22 de junio
