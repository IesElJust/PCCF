...
- **Aula taller de xarxes:** muntatge, crimpat, canalitzacions, racks i proves físiques.
- **Laboratori d’informàtica:** simulació, mapes, configuració i documentació.
- **Instal·lacions del centre:** observació, inventari i actuacions autoritzades.
- **Aules/Teams:** materials, lliuraments, comunicació, seguiment i feedback.

L’ús de trepants, escales, eines de tall, racks i instal·lacions requerirà instrucció prèvia, supervisió i aplicació de les normes de prevenció. L’espai quedarà ordenat i segur al final de cada sessió.
