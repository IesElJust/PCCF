...
El mòdul 3016 s’associa a les competències i estàndards d’instal·lació i manteniment de xarxes de transmissió de dades del perfil d’Informàtica i Comunicacions. La correspondència concreta amb acreditacions parcials es concretarà en els documents curriculars vigents.

| Àmbit | Mòduls relacionats | Aportació d’IMX |
|---|---|---|
| Muntatge i manteniment | 3029. Muntatge i manteniment de sistemes; 3016. IMX | Preparació d’equips, connexió, cablejat, verificació i manteniment. |
| Xarxes | 3016. IMX; 3030. Operacions auxiliars per a la configuració i explotació | Instal·lació física, plànols, mitjans de transmissió, xarxes locals i diagnòstic. |
| Prevenció i qualitat | Ciències Aplicades II; Itinerari/Ocupabilitat; Tutoria | Seguretat, ordre, sostenibilitat, comunicació i responsabilitat. |
| Documentació | Comunicació i Societat II; Ofimàtica i arxiu | Plànols, inventaris, etiquetatge, informes i presentacions. |
