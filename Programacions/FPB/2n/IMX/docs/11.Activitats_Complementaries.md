...
- Visita o xarrada d’una empresa instal·ladora o de manteniment de xarxes.
- Visita al CPD, rack principal o infraestructura de comunicacions del centre, si és viable.
- Activitat sobre reciclatge de RAEE i sostenibilitat.
- Col·laboració amb el projecte intermodular i exposició final del projecte ApS.

Qualsevol activitat requerirà autorització, planificació de riscos, accessibilitat, alternativa educativa i registre de les evidències.
