...
Cable UTP Cat 5e/6, coaxial i, si està disponible, fibra òptica; connectors RJ45, preses, rosetes, patch panels, racks, canaletes, tubs, safates, brides, cargols, tacs, etiquetes, eines de crimpat i pelat, guia passacables, tornavís, alicates, trepant autoritzat, testador de xarxa i equips de protecció individual.

## Recursos digitals i didàctics

Packet Tracer o simulador equivalent, draw.io/diagrams.net, eines de diagnòstic, VirtualBox, Raspbian/Raspberry Pi, OpenWrt, Nginx, SSH i el llibre obert **The Linux Command Line** (capítols 1–9), manuals de fabricants, fitxes pas a pas, vídeos curts, plànols del centre, llistes de verificació, rúbriques, Aules i Teams.

Els recursos es seleccionaran segons disponibilitat, accessibilitat, llicència, seguretat i sostenibilitat. No s’instal·larà programari ni es manipularà la infraestructura real sense autorització.
