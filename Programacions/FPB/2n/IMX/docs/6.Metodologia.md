# 6. Metodologia del procés d’ensenyament-aprenentatge

- Aprenentatge basat en projectes i reptes, amb un producte funcional o documentat.
- Aprenentatge servei, connectant les tasques amb una necessitat real del centre.
- Explicació breu i demostració abans de cada pràctica; després, pràctica guiada i autònoma.
- Treball cooperatiu amb rols rotatius: seguretat, materials, muntatge, verificació i documentació.
- Resolució d’incidències i casos reals, utilitzant l’error com a font d’aprenentatge.
- DUA: representació multimodal, opcions de participació i diverses formes d’expressar l’aprenentatge.
- Integració de comunicació tècnica, competència digital, sostenibilitat, igualtat i orientació professional.
- Feedback formatiu, autoavaluació i coavaluació abans de la qualificació.

Cada pràctica inclourà, quan siga necessari, comprovació de riscos, materials, seqüència de passos, evidència de lliurament i revisió final de l’espai.
