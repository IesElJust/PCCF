...
La resposta educativa es planificarà amb el DUA a partir de l’avaluació inicial i de la coordinació amb tutoria, orientació i equip docent.

- Materials amb llenguatge clar, pictogrames, esquemes, vídeos subtitulats i demostracions.
- Instruccions seqüenciades, models resolts, plantilles i llistes de verificació.
- Tasques amb diferents nivells de suport i ampliació, mantenint el mateix RA.
- Parelles o equips heterogenis, rols flexibles i tutoria entre iguals.
- Temps addicional, pauses, adaptació dels instruments i diferents formes de resposta quan estiga justificat.
- Reforç de vocabulari tècnic, càlculs bàsics, lectura de plànols i expressió escrita.
- Mesures d’accessibilitat física i digital i eliminació de barreres de participació.
- Seguiment individual amb evidències, acords de millora i comunicació amb les famílies quan corresponga.

Les adaptacions ajustaran accés, suports, temps i forma de resposta, però no reduiran els resultats d’aprenentatge prescriptius.
