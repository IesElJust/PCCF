# Programació didàctica PPS

## Fitxers d'edició

- `docs/`: contingut principal de la programació.
- `PD_PPS.ods`: font de les taules de `04`, `05` i `10`.
...
- `programacio-didactica_PPS.pdf`: última exportació a PDF.

## Flux recomanat

1. Editar `docs/` i, si cal, `PD_PPS.ods`.
