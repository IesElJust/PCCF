# Programació didàctica OPT

## Fitxers d'edició

- `docs/`: contingut principal de la programació.
- `PD_CLOUD.ods`: font de les taules de `04`, `05` i `10`.
...
- En este projecte, els fitxers afectats actualment són `2-relacio-uc.md`, `3.contribucio_ra.md`, `4.RAs_CAs_Continguts.md`, `5.esquema_general_up.md` i `10.Avaluacio.md`.
...
- `programacio-didactica_OPT.pdf`: última exportació a PDF.

## Flux recomanat

1. Editar `docs/` i, si cal, `PD_CLOUD.ods`.
