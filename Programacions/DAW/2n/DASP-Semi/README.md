# Programació didàctica DASP

## Fitxers d'edició

- `docs/`: contingut principal de la programació.
- `DASP_DAW.ods`: font de les taules de `04`, `05` i `10`.
...
- `programacio-didactica_DASP.pdf`: última exportació a PDF.

## Flux recomanat

1. Editar `docs/` i, si cal, `DASP_DAW.ods`.
