...
def extract_content_xml(ods_path):
    """Extracts content.xml from an ODS file and stores it in a temporary directory."""
    # Obtén un directorio temporal válido para el sistema operativo
    tmp_dir = tempfile.gettempdir()
    out_path = os.path.join(tmp_dir, "content.xml")
