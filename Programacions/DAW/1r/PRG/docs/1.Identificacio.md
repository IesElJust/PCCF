...
* **Docents responsables**
    ...
    * Francisco Javier Galera Taberner
...
L'any anterior es va proposar aprofundir únicament en el llenguatge Java per tal de facilitar l'assimilació de conceptes i també fer un major nombre de pràctiques per tal que els alumnes assolisquen la competència professional associada a aquest mòdul.
