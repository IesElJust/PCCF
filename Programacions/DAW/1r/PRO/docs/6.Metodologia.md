...
* En la **modalitat presencial**:
    ...
    * **Aprenentatge basat en Reptes (ABR)** mitjançant el desenvolupament de práctiques al llarg dels trimestres des de un nivell de dificultat baixa fins a més elevada.
