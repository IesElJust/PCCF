...
Enfocament: contínua, criterial i orientada a evidències (inicial, contínua i sumativa), alineada amb el RD 659/2023 i la seua modificació pel RD 658/2024, i en coherència amb la Guia Didàctica 2025-26 del centr
...
* **Mínims per a fer mitjana:**
  * Exàmens ≥ 4,0/10 (obligatori assolir aquest mínim).
  * Pràctiques/entregues ≥ 4,0/10 i entrega obligatòria de les pràctiques en Aules.
  * Nota d'avaluació ≥ 5,0/10 després d'aplicar la fórmula.
* **Fórmula de qualificació per avaluació**
   * Nota_aval = 0,70 × Exàmens + 0,30 × Pràctiques (Aules + classe)
* **Regles addicionals:**
